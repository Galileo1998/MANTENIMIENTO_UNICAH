				...
				<div className='event-window__popup'>
					...
					<form className='event-window__form' onSubmit={handleSubmit(submit.bind(this))}>
						...
						<div className='event-window__dates'>
							...
							<Field component={inputDate} type='date' name='dateEnd' label='Termina:' value={dateEnd} required={true} novalidate/>
						</div>
						<h3 className='event-window__subtitle'>Duración (Todo el día o ciertos períodos de tiempo)</h3>
						<div className='event-window__all-day'>
							...
							<label className='event-window__checkbox-label event-window__checkbox-label_large' htmlFor='all-day'>Todo el día</label>
						</div>
						<div className='event-window__period'>
							<Field component={inputTime} type='time' name='timeBegin' label='Inicia:' disabled={allDay} required={!allDay} novalidate/>
							<Field component={inputTime} type='time' name='timeEnd' label='Termina:' disabled={allDay} required={!allDay} novalidate/>
						</div>
						<h3 className='event-window__subtitle'>Días de la semana</h3>
						<div className='event-window__repeat'>
							...
							<label className='event-window__checkbox-label event-window__checkbox-label_large' htmlFor='periodic'>Ciertos días</label>
						</div>
						<Field component={periodicField} type='checkbox' name='week' disabled={!periodic}/>
						<h3 className='event-window__subtitle'>Grupos</h3>
						<div className='event-window__groups'>
							<div className='event-window__link-cont'>
								<a className='event-window__add' onClick={addGroup}>Añadir grupo</a>
							</div>
						...
						<div className='event-window__notification'>
							...
							<label className='event-window__checkbox-label event-window__checkbox-label_large' htmlFor='notification'>Activar notification al escritorio</label>
						</div>
						<div className='event-window__control'>
							<button className='event-window__button' type='submit'>Guardar</button>
							{ id ? deleteButton : ''}
						</div>
					</form>
				</div>
