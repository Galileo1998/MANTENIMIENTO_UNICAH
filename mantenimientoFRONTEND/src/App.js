      ...
      <Router>
        ...
        <NavBar auth={this.state.auth} />
          ...
          >
              ...
              <PrivateRoute path="/reporte/:id/:idEdificio/:nombreEdificio/:pisosEdificio/:bannosEdificio/:aulasEdificio/:oficinasEdificio/:observacion/:elementoReporte/:descripcionReporte/:nombre/:identidad/:dia/:mes/:anno/:imagenReport/:codigoActividad" auth={this.state.auth}  component={Reportes}/>
